...
<?php include('meniu.php');?>
        <div class="card bg-light">
            <article class="card-body mx-auto" style="max-width: 600px;">
                ...
                <form action="http://localhost/cursPHP/curs8/post.php" method="post" enctype="multipart/form-data">
                    
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text"> <i class="fa fa-user"></i> </span>
                        </div>
                        <input name="prenume" class="form-control" placeholder="Preume" type="text">
                    </div>
                    <!-- form-group// -->
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
                        ...
                        <input name="nume" class="form-control" placeholder="Nume" type="text">
                    </div>
                    <!-- form-group// -->
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
                        ...
                        <input name="email" class="form-control" placeholder="Adresa de email" type="email">
                    </div>
                    <!-- form-group end.// -->
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
                    ...
                    <div class="form-group input-group">
                        ...
                        <input name='datanastere' class="form-control" placeholder="Data de nastere" type="text" onfocus="(this.type='date')" onblur="(this.type='text')">
                    </div>
                  <!-- form-group// -->
                  <div class="form-group input-group">
                        <div class="input-group-prepend">
                    ...
                    <div class="form-group input-group">
                        ...
                        <input name="telefon" class="form-control" placeholder="Telefon" type="tel">
                    </div>
                    <!-- form-group// -->
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
